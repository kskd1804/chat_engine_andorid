...
public class SyncDBConnector extends AsyncTask<String,Void,String>{
    ...
    public static String addUser(User user){
        executed=0;
        return_update=0;
        SyncDBConnector add = new SyncDBConnector();
        add.RESULT="";
    ...
    public static User updateUser(User user){
        ...
        return_update=0;
        User u = new User();
        SyncDBConnector update = new SyncDBConnector();
        update.RESULT="";
        DateFormat df = new SimpleDateFormat("yyyy-MM-dd");
    ...
    public static User getUser(User user){
        return_update=0;
        User u = new User();
        SyncDBConnector get = new SyncDBConnector();
        get.RESULT="";
        ...
        while(true){
            if(!get.RESULT.equals("")){
                ...
                if(!get.RESULT.contains(user.getEmail())){
                    Log.i("cE","u is null");
                    u = null;
                    return u;
                }else{
                    Log.i("cE","u is not null");
                    u = strToUser(get.RESULT);
                    return  u;
                }
            }
        }
    ...
    public static User getUser(String username){
        ...
        while(true){
            if(!get.RESULT.equals("")){
                if(!get.RESULT.contains(username)){
                    u = null;
                    return u;
                }else{
                    u = strToUser(get.RESULT);
    ...
    private static Message[] strToMessages(String result)
    {
        ...
        if(result.equals("Empty String!")){
            ...
            Log.i("SyncService", "Message array created!");
            for(i=0;i<j;i++){
                ...
                Log.i("SyncService", "Message " + i + " is " + messages[i].getMsg());
            }
            Log.i("SyncService", "Message array returned!");
            return messages;
        }
    }
    ...
    public static Message getMessage(Message message){
        ...
        while(true){
            if(!get.RESULT.equals("")){
                messages = strToMessage(get.RESULT);
                return messages;
            }
        }
    }
    ...
    protected String doInBackground(String... params) {
        ...
        if(seq_code.equals("1"))
        {
            try {
                ...
                if(!RESULT.equals("Empty String!"))
                Log.i("SyncService","Data Read SyncDBConnector is "+RESULT);
                return RESULT;
